            ...
            <div className="col-span-4 space-y-4">
              ...
              <Card title="Key Dates">
                <div className="space-y-3">
                  ...
                  <Field label="Expected install" value={fmtDay(location.expected_install_date, { day: '2-digit', month: '2-digit', year: 'numeric' }) || null} />
                  <Field label="Actual install" value={fmtDay(location.actual_install_date, { day: '2-digit', month: '2-digit', year: 'numeric' }) || null} />
                  <Field label="Go-live" value={fmtDay(location.go_live_date, { day: '2-digit', month: '2-digit', year: 'numeric' }) || null} />
                  <Field label="Activation" value={fmtDay(location.activation_date, { day: '2-digit', month: '2-digit', year: 'numeric' }) || null} />
                </div>
              </Card>
