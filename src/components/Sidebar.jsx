...
export const COLLAPSIBLE = [
  ...
  { id: 'workforce', label: 'Workforce', items: [
    ['handover', 'Handover', ClipboardList], ['time', 'Time Tracking', Clock], ['schedule', 'Schedule', Calendar], ['timesheets', 'Timesheets', ClipboardCheck, 'owner'], ['bookings', 'Booking Page', CalendarCheck], ['timeoff', 'Time Off', Plane],
...
const ACTIVE_MAP = {
  ...
  ticket_detail: 'tickets', inbox_mail: 'inbox', work: 'work_board', form_detail: 'forms', feature_request_detail: 'feature_requests',
  release_detail: 'releases', invoice_detail: 'invoices', quote_detail: 'quotes',
  bill_detail: 'bills', expense_detail: 'expenses',
};

const DEFAULT_GROUPS = { appbuild: false, crm: true, sales: true, finance: false, inventory: true, delivery: false, support: false, product: false, workforce: false, insights: false };
