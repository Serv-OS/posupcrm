...
const ACTIVE_MAP = {
  ...
  ticket_detail: 'tickets', work: 'work_board', form_detail: 'forms', feature_request_detail: 'feature_requests',
  release_detail: 'releases', invoice_detail: 'invoices', quote_detail: 'quotes',
  bill_detail: 'bills', expense_detail: 'expenses',
};

const DEFAULT_GROUPS = { appbuild: false, crm: true, sales: true, finance: false, inventory: true, delivery: false, support: true, product: false, workforce: false, insights: false };
