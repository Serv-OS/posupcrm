...
const COLLAPSIBLE = [
  ...
  { id: 'workforce', label: 'Workforce', items: [
    ['time', 'Time Tracking', Clock], ['schedule', 'Schedule', Calendar], ['timesheets', 'Timesheets', ClipboardCheck, 'owner'], ['bookings', 'Booking Page', CalendarCheck], ['timeoff', 'Time Off', Plane],
