...
export async function handleClosedWon(dealId, profileId) {
  ...
  // location, and not copying it here is what left 26 of 27 onboardings pinned
  // to a company instead of a site — several of them under a partner with two
  // dozen venues, where "the company" tells you nothing about where the install
  // actually is.
  ...
  // Fallback: a company with exactly one venue has no ambiguity to resolve.
